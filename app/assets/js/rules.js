...
export const CRIME_RULES = [
  ...
  { rx: /ধর্ষণ|rape/i, types: ["rape"], label: "ধর্ষণ / Rape" },
  { rx: /এসিড নিক্ষেপ|এসিডে পুড়|acid (throw|attack|burn)/i,
    types: ["acid_violence"], label: "এসিড সহিংসতা / Acid violence" },
  { rx: /যৌতুক|dowry/i, types: ["dowry"], label: "যৌতুক নির্যাতন / Dowry" },
  { rx: /খুন|হত্যা|গুলি করে মারা|মৃতদেহ|murder|stabbed to death|shot dead/i,
  ...
  { rx: /চুরি|চুরি হয়েছে|পকেট কেটে|দোকান ভেঙে|theft|stole|stolen|broken into/i,
    types: ["theft"], label: "চুরি / Theft" },
  { rx: /ছিনতাই|অস্ত্র দেখিয়ে|snatch|robb/i, types: ["robbery"], label: "ডাকাতি / Robbery" },
  { rx: /গ্যাং|দলবদ্ধ.*লুট|পাঁচ.*জনের|dacoity|armed gang/i, types: ["dacoity"], label: "দলবদ্ধ ডাকাতি / Dacoity" },
  { rx: /মারধর|মারপিট|জখম|লাঠি দিয়ে|ছুরি মেরে আহত|beaten|injur/i,
    types: ["hurt"], label: "আঘাত / Hurt" },
  { rx: /আক্রমণ|থাপ্পড়|assault|criminal force/i, types: ["assault_women", "hurt"],
    label: "আক্রমণ / Assault" },
  { rx: /অপহরণ|নিয়ে গেছে|গাড়িতে তুলে|মুক্তিপণ|kidnap|abduct/i,
  ...
  { rx: /প্রতারণা|ভুয়া চাকরি|ভুয়া প্রতিশ্রুতি|টাকা নিয়ে পালিয়ে|cheat|fraud|false promise/i,
  ...
  { rx: /ফেসবুকে ভুয়া|ভুয়া বিকাশ|অনলাইন শপিং|fake.*ID.*fraud|online shopping.*fraud/i,
  ...
  { rx: /ইয়াবা|মাদক|গাঁজা|হিরোইন|yaba|ganja|heroin|narcotic|drug/i,
    types: ["narcotics"], label: "মাদক অপরাধ / Narcotics" },
  { rx: /ঘুষ|দুর্নীতি|টেন্ডারবাজি|সরকারি অর্থ|brib|corrupt|public funds/i,
